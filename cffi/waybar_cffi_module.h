// Vendored from Waybar (Alexays/Waybar, MIT):
//   resources/custom_modules/cffi_example/waybar_cffi_module.h
// ABI version pinned to 2. If Waybar ever requires a newer ABI, this module
// fails closed at load time (see sysmon.c) instead of misrendering.
// Check upstream when upgrading the Waybar dependency.
#pragma once
